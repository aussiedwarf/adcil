...
#define AD_COLOR_GET_NUM(color) ((color >> 2ULL) & 7ULL)
...
#define AD_COLOR_PAD8 AD_COLOR_BUILD(AD_COLOR_PAD, 8ULL)
...
#define AD_IMG_BGRX8 AD_COLOR_BUILD4(AD_COLOR_PALETTE, 4ULL, AD_COLOR_UNSIGNED, AD_COLOR_RGB, AD_COLOR_BLUE8, AD_COLOR_GREEN8, AD_COLOR_RED8, AD_COLOR_PAD8)
...
#define AD_IMG_BGRX32 AD_COLOR_BUILD4(0ULL, 4ULL, AD_COLOR_UNSIGNED, AD_COLOR_RGB, AD_COLOR_BLUE8, AD_COLOR_GREEN8, AD_COLOR_RED8, AD_COLOR_PAD8)
